// ==UserScript==
// @name         Fireb AI Web Analyzer Galaxy Sidebar (YOUR LOCAL AI)
// @namespace    http://localhost
// @version      6.1
// @description  Fixed: localhost:5000 → YOUR AI at C:\MyAI\web_agent.py
// @author       Fireb + Perplexity
// @match        *://*/*
...
(function() {
    ...
    GM_addStyle(`
        ...
        #ai-panel.desktop { width: clamp(260px, 32vw, 300px); }
        #ai-panel.mobile {
            left: 10px !important;
    ...
    panel.innerHTML = `
        <div class="ai-header">
            ...
            <h2 class="ai-title">YOUR AI 🧠</h2>
            <p class="ai-subtitle">C:\MyAI → localhost:5000</p>
        </div>
    ...
    async function runAI() {
        ...
        showStatus('→ YOUR localhost:5000...', 'success');

        try {
            const response = await new Promise((resolve, reject) => {
                GM_xmlhttpRequest({
                    method: 'POST',
                    url: 'http://localhost:5000/analyze',  // ✅ YOUR LOCAL AI
                    ...
                    onerror: () => reject(new Error('🚫 Server offline. Run: cd C:\\MyAI && ai_env\\Scripts\\activate && python web_agent.py')),
            ...
            showStatus('✅ YOUR AI finished!', 'success');
        } catch (e) {
